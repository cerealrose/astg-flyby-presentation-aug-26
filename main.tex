%=======================================================================
%  The Earth Flyby Anomaly in the Azimuthally Symmetric Theory
%  of Gravitation
%
%  P. A. Nesvinga
%  MPhil in Fundamental Theoretical Astrophysics
%  National University of Science & Technology, Bulawayo
%
%  COMPILE:  pdfLaTeX  (Overleaf: Menu -> Compiler -> pdfLaTeX)
%            One pass is enough; no bibliography run required.
%
%  ANIMATIONS: the three animated figures use the `animate' package.
%  They play in Adobe Acrobat and PDF-XChange. Overleaf's built-in
%  previewer, browser viewers and macOS Preview show the first frame
%  only -- every first frame is a complete standalone figure, so the
%  deck reads correctly either way. Present from Acrobat if you want
%  the motion.
%
%  To hand out a static version, replace \animategraphics{...}{anim/x-}{0}{31}
%  with \includegraphics{anim/x-0}.
%=======================================================================
...
%-----------------------------------------------------------------------
%  Backup slides.  Set to \backuptrue to append three extra frames after
%  the summary covering sample size, the Juno elimination study, and the
%  per-flyby coupling.  They sit after the final frame, are excluded from
%  the page count by appendixnumberbeamer, and never display unless you
%  navigate to them -- useful to have loaded during questions.
%  Default: off, so the compiled deck is exactly twelve pages.
%-----------------------------------------------------------------------
\newif\ifbackup
\backupfalse

%=======================================================================
%  A self-contained theme.  No external fonts, no theme packages: this
%  compiles identically on any TeX distribution.
%=======================================================================
\usetheme{default}
...
% Frame title: bold title with a thin rule underneath
...
% Footline: short title, and slide number
...
%=======================================================================
%  BACKUP  (disabled by default -- see \backupfalse at the preamble)
%=======================================================================
\ifbackup
\appendix
